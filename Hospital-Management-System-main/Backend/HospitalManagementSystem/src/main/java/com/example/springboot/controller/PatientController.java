...
public class PatientController {
	...
	@PostMapping("/{pid}/{newpassword}")
	public Patient changePatientPassword(@PathVariable("pid") long patientId,@PathVariable("newpassword") String newpassword) {
	...
	public Patient getPatientByEmail(@RequestBody Patient patient) {
		return patientService.getPatientByEmail(patient);
	}
}
