...
public class PatientServiceImpl implements PatientService{
	...
	public Patient getPatientByEmail(Patient patient) {
		return this.patientRepository.findByPatientEmailId(patient.patientEmailId).orElseThrow(() -> new ResourceNotFoundException("Patient ", "Email", patient.patientEmailId));
	}
