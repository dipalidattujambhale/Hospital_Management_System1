...
import { DoctorforgotpasswordComponent } from './components/doctorforgotpassword/doctorforgotpassword.component';
...
const routes: Routes = [
  ...
  { path: 'doctorforgot-password', component: DoctorforgotpasswordComponent },
