...
export class HospitalService {
  ...
  deleteAppontmentById(id: any): Observable<any> {
    return this.http.delete(this.url + "/api/booking/"+ id);
  }
  ...
  forgotPassword(body: any):Observable<any> {
    return this.http.post(this.url + "/api/patient/forgotpassword", body);
  }

  doctorChangePassword(did: any,password:any):Observable<any> {
    return this.http.post(this.url + "/api/doctor/"+did+"/"+password,{});
  }

  doctorForgotPassword(body: any):Observable<any> {
    return this.http.post(this.url + "/api/doctor/forgotpassword", body);
  }
}
